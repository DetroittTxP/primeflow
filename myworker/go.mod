// A worker image of your own. This is a separate Go module on purpose: it
// depends on PrimeFlow, it does not fork it. Change the module path to
// wherever this directory ends up.
module github.com/DetroittTxP/primeflow-myworker
